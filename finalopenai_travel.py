...
# Update the database times to the present
...
# Define the VectorStoreRetriever class
...
# Tool to fetch user flight information
@tool
...
# Tool to update ticket to a new flight
@tool
...
# Tool to update a hotel booking
@tool
def update_hotel(
    hotel_id: int,
    checkin_date: Optional[Union[datetime, date]] = None,
...
# Tool to cancel a hotel booking
@tool
...
while True:
    ...
    events = assistant({"messages": [("user", user_question)]}, config)
